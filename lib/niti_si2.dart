...
var nss0 = Column(
  children: <Widget>[
    ...
    const ListTile(
      title: Text('　一方で、短気、反省が足りない、準備不足、指示や命令されるのが嫌い、できればはやく独立したいといった特徴もあります。'),
    ),
    const ListTile(
      title: Text('　とにかく勢いがあります。'),
    ),
    const ListTile(
      title: Text('　例えば、町内会で掃除をすれば、どんどん掃除し早く済ませますが、綺麗になっているか振り返ることはありません。'),
    ),
    const ListTile(
      title: Text('　また、町内会の役員の選出などでは、役職、地位に弱く、おだてられると木に登るタイプなので、すぐ引き受けてしまいます。'),
    ),
    const ListTile(
      title: Text(
    ...
    const ListTile(
      title: Text('　また、荷物をもってエレベータの前に立っている場合、エレベータが来るのを待つぐらいなら、階段で行ってしまいます。'),
    ),
    ListTile(
...
var nss1 = Column(
  children: <Widget>[
    ...
    const ListTile(
      title: Text('　十二運のうち、胎・養・沐・墓　が四平に属します。基本はこの四つですが、ここに衰・絶も加えてもいいくらいです。'),
    ),
    ListTile(
      title: Image.asset('assets/images/juuniun/十二運の強弱.jpg'),
    ),
...
var nss2 = Column(
  children: <Widget>[
    ...
    const ListTile(
      title: Text('　また、荷物をもってエレベータの前に立っている場合、階段を使うことはありません。エレベータが来るまで待ちます。'),
    ),
    ListTile(
      title: Image.asset('assets/images/juuniun/エレベータ階段.jpg'),
    ),
  ...
  children: [
    ...
    ListTile(
        title: Text('　しかし、安心してはいけません。強い運勢を自分のためだけに使ったら、'
            ...
            '強い運勢は、他の人を助けるために天が与えたものです。他のために生きてこそ「吉」となります。'),
    ),
  ],
);
...
var nsss1 =  const Column(
  children: [
    ...
    ListTile(
      title: Text('　しかし、安心してはいけません。平凡な運勢を自分のためだけに使ったら、'
          'なんとなく過ごし「凶」となります。平均的な運勢は、天が与えたものです。'
          'ときには外的な面、例えば体力や財力で、ときには内的な面、心で寄り添うことで、'
          '他の人のために尽くすと「吉」となります。あなたは、それができる人です。'),
    ),
  ],
);
  ...
  children: [
    ...
    ListTile(
      title: Text('　しかし、落胆することはありません。辛いことに遭遇したとき、どうして自分はこうなんだと嘆くと、'
          '「凶」となります。強い運勢の人に出会うと、相手は悪気がなかったとしても、こちらは傷ついてしまう傾向にあります。'
          '弱い運勢は、天を慰めるために与えたものです。より弱い運勢の人に寄り添ってあげると、'
          'その人はあなたによって希望を抱きます。天に代わって寄り添ってくれたことを天は祝福することでしょう。'
          'これは、運勢の強い人にはできないことです。他のために寄り添って生きてこそ「吉」となります。'),
    ),
  ],
);
